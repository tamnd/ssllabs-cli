...
Most of these come down to network reality or how ssllabs serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ssllabs rate-limits like any public site. ssllabs already paces
...
Where a surface is gated, ssllabs reads a cookie or token you supply
...
`ssllabs`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ssllabs actually did
