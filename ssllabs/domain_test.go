...
// HTTP behaviour is covered in ssllabs_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ssllabs://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ssllabs", "about")
	if err != nil || got.String() != "ssllabs://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ssllabs://page/about", got.String(), err)
	}
}
